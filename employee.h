...
class Employee {
	...
	public:
		...
		//made public because these were needed public and the compiler got mad at me for not having them public.
...
//everything was kept the same, aside from the slight change in private to public. 